...
router.route("/sms/inbound").post((0, validate_1.default)(inbound_1.default), sms_controller_1.default.inbound);
router.route("/sms/outbound").post((0, validate_1.default)(outbound_1.default), sms_controller_1.default.outbound);
